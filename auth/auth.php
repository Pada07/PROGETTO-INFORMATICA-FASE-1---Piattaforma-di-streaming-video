...
<body class="bg-light">
    <div class="container mt-5">
        ...
        // Se nell'URL c'è la variabile "errore" (es. index.php?errore=1), mostra il messaggio rosso
            ...
            // Questo è il NUOVO avviso per gli errori di registrazione
            if (isset($_GET['errore_reg'])) { 
                echo "<div class='alert alert-warning'>Attenzione: Errore durante la registrazione. Forse l'email è già in uso? Verifica i dati e riprova.</div>";
            }
        ?>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card p-4 shadow-sm">
                    <h3>Accedi</h3>
                    <form id="formAccedi" action="login.php" method="POST"> 
