...
--
-- Host: 127.0.0.1
-- Creato il: Apr 17, 2026 alle 11:59
...
--
ALTER TABLE `account`
  MODIFY `ID_Account` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `utente`
  MODIFY `ID_Utente` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
